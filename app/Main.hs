...
prop_nAnd x y = nAnd x y == nAnd_1 x y && nAnd_1 x y == nAnd_2 x y

prop_nAnd_1 :: Bool -> Bool -> Bool
prop_nAnd_1 False x = nAnd False x == True
prop_nAnd_1 x False = nAnd x False == True
prop_nAnd_1 _ _ = True
